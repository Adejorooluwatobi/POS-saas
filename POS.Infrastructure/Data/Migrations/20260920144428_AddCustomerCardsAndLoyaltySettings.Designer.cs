...
namespace POS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260920144428_AddCustomerCardsAndLoyaltySettings")]
    partial class AddCustomerCardsAndLoyaltySettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "payment_method", new[] { "cash", "card", "mobile_money", "bank_transfer", "gift_card", "store_credit", "split" });
            ...
            modelBuilder.Entity("POS.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<int?>("RollsPerPack")
                        .HasColumnType("integer");

                    b.Property<int?>("SinglesPerPack")
                        .HasColumnType("integer");

                    b.Property<int?>("SinglesPerRoll")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("POS.Domain.Entities.Staff", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EmployeeNo")
                        .IsUnique()
                        .HasDatabaseName("IX_Staff_TenantId_EmployeeNo");
            ...
            modelBuilder.Entity("POS.Domain.Entities.StoreProductOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("StoreProductOverrides");
                });
            ...
            modelBuilder.Entity("POS.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Slug = "system",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 20, 14, 44, 26, 696, DateTimeKind.Unspecified).AddTicks(2839), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
