...
namespace POS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260516165206_MakeVariantIdNullable")]
    partial class MakeVariantIdNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsVerified = false,
                            Slug = "system",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 5, 16, 16, 52, 1, 998, DateTimeKind.Unspecified).AddTicks(3374), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
