...
namespace POS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260516171034_AddTransactionItemProductName")]
    partial class AddTransactionItemProductName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsVerified = false,
                            Slug = "system",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 5, 16, 17, 10, 30, 808, DateTimeKind.Unspecified).AddTicks(3753), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
