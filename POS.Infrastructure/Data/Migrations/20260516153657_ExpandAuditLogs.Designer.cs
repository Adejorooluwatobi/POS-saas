...
namespace POS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260516153657_ExpandAuditLogs")]
    partial class ExpandAuditLogs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsVerified = false,
                            Slug = "system",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 5, 16, 15, 36, 53, 843, DateTimeKind.Unspecified).AddTicks(9812), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
