...
namespace POS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260917083500_AddQuantityReceivedBaseUnits")]
    partial class AddQuantityReceivedBaseUnits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsVerified = false,
                            Slug = "system",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 17, 8, 34, 54, 934, DateTimeKind.Unspecified).AddTicks(7778), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
